...
plot \
"dat/dst.dat" u ($0*10):($1) w l lc rgb "#ff8080"  t"$1$" ,\
"dat/dst.dat" u ($0*10):($2) w l lc rgb "#8080ff"  t"$2$" ,\
"dat/dst.dat" u ($0*10):($3) w l lc rgb "#ffff80"  t"$3$" ,\
"dat/dst.dat" u ($0*10):($4) w l lc rgb "#808080"  t"$0$"


unset output

#"dat/dst.dat" every 10 u ($0*10):($1) w l lc rgb "#ff8080"  t"$1$" ,\
